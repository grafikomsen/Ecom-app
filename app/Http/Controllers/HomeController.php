...
class HomeController extends Controller
{
    public function home(){
        ...
        $slides      = Banner::orderBy('name','DESC')->where('status',1)->take(3)->get();

        return view('home', compact('featuredProducts','latestProducts','olderProducts','feaProducts','latProducts','oldProducts','slides'));
    }
