                        ...
                        <div class="card shadow-sm border-0">
                            <div class="card-body checkout-form">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <input type="text" name="address" id="address" placeholder="Adresse" class="form-control"></input>
                                            {{-- <p></p> --}}
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <input type="text" name="appartment" id="appartment" class="form-control" placeholder="Appartement, suite, unit, etc. (optional)">
                                            {{-- <p></p> --}}
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                @foreach(Cart::content() as $item)
                                    <div class="d-flex justify-content-between pb-2">
                                        ...
                                        <div class="h6">{{ $item->price*$item->qty }} CFA</div>
                                    </div>
                                @endforeach
                                <hr>
                                <div class="d-flex justify-content-between summery-end">
                                    <div class="h6"><strong>Subtotal</strong></div>
                                    <div class="h6"><strong>{{ Cart::subtotal() }} CFA</strong></div>
                                </div>
