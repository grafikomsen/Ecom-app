        ...
        <div class="container-fluid my-2">
            <div class="row mb-2">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{ route('admin.categorie.create') }}" class="btn btn-primary">New Category</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                ...
                <form action="" method="GET">
                    <div class="card-header">
                        <div class="card-title">
                            <a class="btn btn-default btn-sm" href="{{ route('admin.categorie') }}">Reset</a>
                        </div>
                            ...
                            @if ($categories->isNotEmpty())
                                @foreach ($categories as $category)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary btn-sm" href="{{ route('admin.categorie.edit',$category->id) }}">
